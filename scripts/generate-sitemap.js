...
try {
  ...
  let siteDomain = process.env.VITE_SITE_DOMAIN || "aiimagecenter.com";
...
async function generateSitemap() {
  try {
    ...
    if (siteConfig.domain.includes('${URL}')) {
      ...
      siteConfig.domain = "aiimagecenter.com";
      siteConfig.siteUrl = "https://aiimagecenter.com";
    }
